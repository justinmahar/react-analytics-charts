...
export interface PageViewsPerPathChartProps {
    ...
    container?: string;
    /** Optional. The options for this chart have been preconfigured, but you can add or override any [TableChartOptions](https://justinmahar.github.io/react-analytics-charts/TableChart#chart-options) you'd like here, such as the `width` or sorting. */

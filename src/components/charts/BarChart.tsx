import { BarChartOptions, GoogleAnalyticsEmbedAPI, Query } from '@devboldly/react-use-google-analytics-embed-api';
...
/**
 * See documentation: [BarChart](https://react-analytics-charts.netlify.com/BarChart)
 *

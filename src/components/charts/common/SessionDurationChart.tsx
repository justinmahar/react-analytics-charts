...
/**
 * See documentation: [SessionDurationChart](https://react-analytics-charts.netlify.com/SessionDurationChart)
 *
 * This [ColumnChart](https://react-analytics-charts.netlify.com/ColumnChart) charts how many seconds are spent on average per session, for each date, until today.
 *

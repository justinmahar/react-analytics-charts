...
<h1>SessionDurationChart</h1>

## Description

This [ColumnChart](/ColumnChart) charts how many seconds are spent on average per session, for each date, until today.

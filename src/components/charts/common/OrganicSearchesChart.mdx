...
import { OrganicSearchesChart } from './OrganicSearchesChart';

<GoogleAnalytics trackingId={TRACKING_ID} />

<h1>OrganicSearchesChart</h1>

## Description

This [LineChart](/LineChart) charts the number of organic searches for each date, until today.

...
The chart prop is an object that specifies the `container` ID, chart `type`, and chart `options` that the [Google Analytics Embed API](https://justinmahar.github.io/react-use-analytics-api/) will use to generate the chart.

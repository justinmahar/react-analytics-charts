...
This component wraps the [`useViewSelector`](https://react-use-analytics-api.netlify.app/useViewSelector) hook from [react-use-analytics-api](https://react-use-analytics-api.netlify.com/).

## Usage

```jsx
import { ViewSelector } from '@devboldly/react-analytics-charts';
```
...
import { AuthorizeButton, SignOutButton, ViewSelector } from '@devboldly/react-analytics-charts';

...
The [AnalyticsDashboard](/AnalyticsDashboard) component makes it easy to embed charts onto your site without having to deal with loading and readying the [Google Analytics Embed API](https://justinmahar.github.io/react-use-analytics-api/), checking authorization, and adding a view selector. The [AnalyticsDashboard](/AnalyticsDashboard) will handle all of that overhead for you.
...
- You might want to use a [React Context](https://reactjs.org/docs/context.html) to manage `gapi` ([Google Analytics Embed API](https://justinmahar.github.io/react-use-analytics-api/)) state.
- You might just want to use only the chart components from this library and ignore everything else!

Read on to see how you can use the included components, and optionally the [Google Analytics Embed API](https://justinmahar.github.io/react-use-analytics-api/) hook, to build a completely custom dashboard.

## Custom Dashboard Example

To build your own dashboard, you'll need to handle a few things:

- Load and ready the [Google Analytics Embed API](https://justinmahar.github.io/react-use-analytics-api/)
...
In addition to [AuthorizeButton](/AuthorizeButton), [SignOutButton](/SignOutButton), and [ViewSelector](/ViewSelector), hooks are available for API access via [react-use-analytics-api](https://justinmahar.github.io/react-use-analytics-api/), which this library uses internally.
...
### Using [Google Analytics Embed API](https://justinmahar.github.io/react-use-analytics-api/)

If you load and ready the API with [react-use-analytics-api](https://justinmahar.github.io/react-use-analytics-api/), or already have `gapi` loaded and readied via your own means, you can add any of the charts by themselves.
...
Just [choose a chart](/charts), then pass it the ready and authorized [Google Analytics Embed API](https://justinmahar.github.io/react-use-analytics-api/) (`gapi`), and the view ID (`viewId`), and it'll render on the page for you.
